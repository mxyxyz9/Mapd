        ...
        MapdCard(variant: .standard) {
            VStack(alignment: .leading, spacing: MapdSpacing.md) {
                ...
                HStack(spacing: MapdSpacing.sm) {
                    ChipButton(title: "Directions", isSelected: false) {
                        openInMaps()
                    }
                    
                    ChipButton(title: "Save", isSelected: true) {
                        // Add to bucket list
                    }
                }
            }
    ...
    var body: some View {
        MapdCard {
            VStack(spacing: MapdSpacing.md) {
                ...
                ChipButton(title: "Try Again", isSelected: false, action: onRefresh)
            }
    ...
    var body: some View {
        MapdCard {
            VStack(spacing: MapdSpacing.md) {
                ...
                ChipButton(title: "Get Suggestions", isSelected: true, action: onRefresh)
            }
            .padding(MapdSpacing.lg)
        }
    }
    ...
    var body: some View {
        MapdCard {
            VStack(spacing: MapdSpacing.md) {
                ...
                ChipButton(title: "Update Interests", isSelected: false) {
...
#Preview {
    RecommendationsSection(
        userInterests: [.history, .food, .nature],
