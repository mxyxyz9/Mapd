...
struct QuickSelectionButtons: View {
    ...
    private let popularInterests: [TravelInterest] = [
        .history, .food, .nature, .adventure, .photography, .history
    ]
    
    private let relaxationInterests: [TravelInterest] = [
        TravelInterest.beaches, TravelInterest.wellness, TravelInterest.luxury, TravelInterest.food, TravelInterest.shopping, TravelInterest.nightlife
    ]
...
#Preview {
    InterestSelectionStep(selectedInterests: .constant([.history, .food, .nature]))
}