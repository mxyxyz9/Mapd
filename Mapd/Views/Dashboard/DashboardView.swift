            ...
            ZStack {
                ...
                ScrollView {
                    LazyVStack(spacing: MapdSpacing.lg) {
                        ...
                        // Quick Stats
                        QuickStatsSection(user: userManager.user)
                        ...
                        // Recent Activity
                        RecentActivitySection(user: userManager.user)
                        ...
                        // Upcoming Trips
                        UpcomingTripsSection(trips: userManager.user.upcomingTrips)
                        
                        // Recommendations
                        RecommendationsSection(
                            userInterests: userManager.user.interests,
        ...
        VStack(alignment: .leading, spacing: MapdSpacing.md) {
            ...
            MapdCard(variant: .elevated) {
                HStack(spacing: MapdSpacing.md) {
                    ...
                    ChipButton("Explore", style: .secondary) {
